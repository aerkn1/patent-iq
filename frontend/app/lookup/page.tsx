...
import { fetchJson, getPatentUrl, getPatentAnalysisUrl } from "@/lib/api"
                          ...
                          <TooltipProvider>
                            ...
                            <div className="space-y-3">
                              ...
                              <Badge
                                variant="outline"
                                className={`mt-2 ${
                                  advancedData.technology.diversification.interpretation === "HIGH" ||
                          ...
                          <TooltipProvider>
                            ...
                            <div className="space-y-3">
                              ...
                              <Badge
                                variant="outline"
                                className={`mt-2 ${
                                  advancedData.market.diversification.interpretation === "HIGH" ||
